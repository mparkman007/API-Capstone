This is a capstone project to create a website tht utilizes a public API. Once downloaded and opened you'll need to run "npm i" to install all the node modules to get the project working. 
